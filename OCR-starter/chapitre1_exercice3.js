...
console.log( "toutes deux de type nombres");
console.log(4+5);

// Cas 2 : 4 et 5 sont toutes deux de type chaîne
console.log( "toutes deux de type chaîne");
console.log("4"+"5");


// Cas 3 : 4 est de type chaîne et 5 est de type nombre
console.log( "4 est de type chaîne et 5 est de type nombre");
console.log("4"+5);

// Cas 4 : Entourer l'expression (VALEUR OPÉRANDE VALEUR) de guillemets
console.log( "Entourer l'expression (VALEUR OPÉRANDE VALEUR) de guillemets");
console.log("4+5");
